/*
 * 1)  delete everything between the //START: and //END: comments
 * 2)  copy/paste all your javascript/D3 code into that gap
 * 3)  get rid of any width or height declarations
 * 4)  upload your .csv in VizPacker
 * 5)  specify the measures
 * 6)  add "meta", "dims", and "Y_measure" - or something similar
 * 7)  change hard-coded data from, e.g. d.year -> d[dims[0]]
 * 8)  copy/paste the css into style.css
 * 9)  add a special class to everything in the css and the js
 *     to override Lumira's default styling
 * 10) delete d3.csv() and its closing brackets
 * 11) name everything through the 'LAYOUT DESIGN' tab
 * 12) save
 * 13) pack
 * 14) add to Lumira
 * 15) smell armpit
